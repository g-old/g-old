exports.up = function (knex, Promise) {
  return Promise.all([
    knex.schema.createTable('flagged_statements', (table) => {
      table.increments();
      table.integer('flagger_id').unsigned().notNullable();
      ...
      table.enu('state', ['open', 'deleted', 'rejected']).notNullable().defaultsTo('open');
